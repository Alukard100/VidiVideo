        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CreatorSubscriptions_Users_CreatorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Follows_Users_CreatorId",
                        column: x => x.CreatorId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProviderPaymentId = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_CreatorSubscriptions_SubscriptionId",
                        column: x => x.SubscriptionId,
                        principalTable: "CreatorSubscriptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ContentReports_Users_ReviewedById",
                        column: x => x.ReviewedById,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ContentReports_Videos_VideoId",
                        column: x => x.VideoId,
                        principalTable: "Videos",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContentReports_ReviewedById",
                table: "ContentReports",
                column: "ReviewedById");

            migrationBuilder.CreateIndex(
                name: "IX_ContentReports_VideoId",
                table: "ContentReports",
                column: "VideoId");

            migrationBuilder.CreateIndex(
                name: "IX_CreatorSubscriptions_CreatorId",
                table: "CreatorSubscriptions",
                column: "CreatorId");

            migrationBuilder.CreateIndex(
                name: "IX_CreatorSubscriptions_SubscriberId_CreatorId_EndsAtUtc",
                table: "CreatorSubscriptions",
                columns: new[] { "SubscriberId", "CreatorId", "EndsAtUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Follows_FollowerId_CreatorId",
                table: "Follows",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VideoViews_UserId_VideoId_CreatedAtUtc",
                table: "VideoViews",
                columns: new[] { "UserId", "VideoId", "CreatedAtUtc" });
