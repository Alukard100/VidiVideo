...
namespace VidiVideo.Application.Abstractions.Repositories
{
    public interface IUserRepository
    {
        ...
        Task<List<AppUser>> GetStaffAsync(string? search, string? role, int page, int pageSize, CancellationToken cancellationToken = default);
        Task<int> CountStaffAsync(string? search, string? role, CancellationToken cancellationToken = default);
